      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 space-y-8">
        <header className="space-y-3">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            使用 CloudHost 部署和托管您的代码，即表示您已阅读、理解并同意本使用协议与
            服务条款的全部内容。如果您不同意本条款，请不要注册、登录或使用本服务。
          </p>
        </header>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            本协议适用于所有使用 CloudHost 网站、控制台、API 以及相关产品与服务的用户，
            包括注册用户和未注册但实际使用服务的访问者。
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            您在注册或登录 CloudHost 账号时，需要提供真实、准确和完整的注册信息（例如邮
            箱地址），并保持其持续更新。您应妥善保管账号和密码，并对在该账号下发生的所
            有行为负责。
          </p>
          <p className="text-sm text-zinc-400 leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            为了保障平台合规、安全运行以及遵守相关法律法规，您上传至 CloudHost 的代码、
            静态资源以及通过本平台对外提供访问的页面内容，将被系统自动进行合规性审核。
          </p>
          <p className="text-sm text-zinc-400 leading-relaxed">
            审核方式可能包括但不限于：图像识别、文本 OCR 识别、LOGO 检测、二维码/条形码
            识别、关键词检测等自动化手段。
          </p>
          <p className="text-sm text-zinc-400 leading-relaxed">
            您在此明确知悉并同意：
          ...
          <ul className="text-sm text-zinc-400 space-y-1 list-disc pl-5">
            <li>内容会被自动审核，审核范围包括代码、静态资源以及生成的页面内容。</li>
            <li>
              审核结果可能导致您的站点或部分内容被下线、访问受限、冻结或封禁，严重情形下
              可导致账号被限制使用。
            </li>
            <li>审核策略会根据法律法规与平台风控策略动态调整，恕不逐一另行通知。</li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            您承诺不会利用 CloudHost 存储、处理、传播任何违反法律法规或本平台规则的内容。
            系统将重点对以下类型内容进行检测和拦截（包括图像、视频、音频、文本等）：
          </p>
          ...
          <div className="space-y-2 text-sm text-zinc-400">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>军警制服、大型军事武器、枪支等热武器、刀剑等冷兵器等敏感元素。</li>
          ...
          <div className="space-y-2 text-sm text-zinc-400">
            <h3 className="font-semibold text-zinc-200">5. 低质及其他不当内容</h3>
            <ul className="list-disc pl-5 space-y-1">
        ...
        <section className="space-y-3">
          ...
          <ul className="text-sm text-zinc-400 space-y-1 list-disc pl-5">
            <li>
              您对使用 CloudHost 部署和发布的全部内容（包括代码、图片、文字等）拥有合法权
              利，或已获得必要的授权。
            </li>
            <li>您对上述内容的合法性、合规性、真实性、完整性承担全部责任。</li>
            <li>
              您不会利用 CloudHost 进行任何侵权、违法或损害他人权益的行为，包括但不限于著作
              权、商标权、隐私权等侵权行为。
            </li>
          </ul>
          <p className="text-sm text-zinc-400 leading-relaxed">
          ...
          <p className="text-sm text-zinc-100 leading-relaxed font-semibold">
            You confirm that you have the legal right to publish this content and
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            如我们在自动审核或人工复核过程中发现您的内容可能存在违规情形，CloudHost
            有权根据情节严重程度采取包括但不限于以下一项或多项措施：
          </p>
          <ul className="text-sm text-zinc-400 space-y-1 list-disc pl-5">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            由于互联网环境复杂多变，CloudHost 会在合理范围内采取技术与管理措施保障服务
            稳定与内容合规，但不对以下情形承担责任：
          </p>
          <ul className="text-sm text-zinc-400 space-y-1 list-disc pl-5">
            <li>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-zinc-400 leading-relaxed">
            我们可能会根据业务发展、法律法规变化等不时更新本协议。更新内容将在本页面公示，
            并自公布之日起生效。您继续使用 CloudHost 服务，即视为接受更新后的协议。
          </p>
        </section>
